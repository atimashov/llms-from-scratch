...
from p1_core.models.transformer import get_attention 
    ...
    def __init__(
        ...
        self.layers = nn.Sequential(
            *[AnnotatedTransformerBlock(
                ...
                context_length = context_length, init_type = init_type, clip_w = clip_w, norms = norms, device = device, 
                dtype = dtype, kv_cache = kv_cache, block_num = block_num
